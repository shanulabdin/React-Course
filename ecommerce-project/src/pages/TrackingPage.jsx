...
export function TrackingPage({ cart }) {
  ...
  const isPreparing = deliveryPercent < 33 && deliveryPercent;
  const isShipped = deliveryPercent >= 33 && deliveryPercent < 100 && deliveryPercent;
  const isDelivered = deliveryPercent >= 100 && deliveryPercent;
